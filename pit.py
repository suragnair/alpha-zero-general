...
def two_model_compete():
    ...
    n2 = NNet(g, input_channels = 2, num_channels = 128)
    n2.load_checkpoint('./checkpoints/gomoku/6*6_numeps_100_num_mcts_sims_100_2_input_channels_128_channels','best.pth.tar')
