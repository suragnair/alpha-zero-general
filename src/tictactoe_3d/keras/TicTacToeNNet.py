...
from tensorflow.python.keras.layers import Reshape, Activation, Conv3D, Dense, Dropout, Flatten
...
class TicTacToeNNet:
    def __init__(self, game, args):
        ...
        h_conv4 = Activation('relu')(BatchNormalization(axis=3)(
            Conv3D(args.num_channels, 3, padding='valid')(
