...
class AleaEvangelii(Tafl):
    def __init__(self):
        ...
        self.pieces = self.expandeighth(self.size,
                                        [[2, 0, -1], [5, 0, -1], [5, 2, -1], [7, 3, -1], [9, 3, -1],
                                         [6, 4, -1], [5, 5, -1], [8, 4, 1], [9, 6, 1], [8, 7, 1],
                                         [9, 8, 1], [9, 9, 2]])
