...
from tafl.GameVariants import Brandubh, ArdRi, Tawlbwrdd, Hnefatafl, AleaEvangelii, Tablut
from tafl.TaflLogic import Board
...
class TaflGame(Game):
    ...
    def getValidMoves(self, board, player):
        ...
        # Note: Ignoreing the passed in player variable since we are not inverting colors for
        # getCanonicalForm and Arena calls with constant 1.
    ...
    def getCanonicalForm(self, board, player):
        b = board.getCopy()
        # rules and objectives are different for the different players, so inverting board
