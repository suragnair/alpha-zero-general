...
from tafl.GameVariants import Tafl
        ...
        for pieceno in range(len(self.pieces)):
            ...
            if piece[2] * player > 0:
                ...
                for x in range(0, self.width):
                    if self._isLegalMove(pieceno, x, piece[1]) >= 0: moves.extend(
                        [[piece[0], piece[1], x, piece[1]]])
                for y in range(0, self.height):
                    if self._isLegalMove(pieceno, piece[0], y) >= 0: moves.extend(
                        [[piece[0], piece[1], piece[0], y]])
        # print("moves ",moves)
        return moves
