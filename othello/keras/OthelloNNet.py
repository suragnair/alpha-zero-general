...
class OthelloNNet():
    def __init__(self, game, args):
        ...
        h_conv4 = Activation('relu')(BatchNormalization(axis=3)(Conv2D(args.num_channels, 3, padding='same')(h_conv3)))         # batch_size  x board_x x board_y x num_channels
        h_conv4_flat = Flatten()(h_conv4)       # batch_size  x (board_x x board_y x num_channels)
        ...
        self.v = Dense(1, activation='sigmoid', name='v')(s_fc2)                    # batch_size x 1
